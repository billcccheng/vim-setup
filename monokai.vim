...
" Javascript
call s:h("javascriptFuncName",          { "fg": s:pink })
call s:h("javascriptReserved",          { "fg": s:pink })
call s:h("javascriptVariable",          { "fg": s:aqua })
call s:h("javascriptIdentifier",        { "fg": s:aqua })
call s:h("javascriptFunctionKey",       { "fg": s:green })
call s:h("javascriptFuncArg",           { "fg": s:orange })
call s:h("javascriptPrototype",         { "fg": s:aqua })
call s:h("javascriptExceptions",        { "fg": s:aqua })
call s:h("javascriptFutureKeys",        { "fg": s:aqua })
call s:h("javascriptBuiltins",          { "fg": s:aqua })
call s:h("javascriptArgsObj",           { "fg": s:aqua })
call s:h("javascriptStatic",            { "fg": s:aqua })
call s:h("javascriptSuper",             { "fg": s:aqua })
call s:h("javascriptFuncArgRest",       { "fg": s:purple, "format": "italic" })
call s:h("javascriptFuncArgs",          { "fg": s:orange, "format": "italic" })
call s:h("javascriptStorageClass",      { "fg": s:aqua })
call s:h("javascriptDocTags",           { "fg": s:aqua,   "format": "italic" })
